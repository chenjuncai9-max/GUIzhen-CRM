...
import { Clock, User, PlusCircle, Download, ScanBarcode, X, Upload, ChevronDown, UserPlus, Phone, Search, CheckCircle, TrendingUp, ShoppingCart } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5 md:p-6 lg:sticky lg:top-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-4 border-t border-slate-100 mt-2">
              ...
              <button
                type="submit"
                className={`w-full py-3.5 rounded-lg text-white font-bold text-lg flex justify-center items-center space-x-2 transition-transform active:scale-95 shadow-md ${isSale ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-emerald-600 hover:bg-emerald-700'
                  }`}
              >
                <CheckCircle size={22} />
